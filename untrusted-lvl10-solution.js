...
function startLevel(map) {
    ...
    map.defineObject('attackDrone', {
        ...
        'behavior': function (me) {
            // Causes drones to change vertical position,
            // which opens the path for the player.
            moveToward(me, 'exit');
        }
    });
    ...
    map.defineObject('reinforcementDrone', {
        ...
        'behavior': function (me) {
            // Moves yellow drones straight right.
            me.move('right');
        }
    });
    ...
    map.defineObject('defenseDrone', {
        ...
        'behavior': function (me) {
             ...
             * Causes drones to change vertical position,
             * which opens the path for the player.
             * Also, since attackDrones are moving right and defense
             * drones are placed right of the attackDrones, when
             * these 2 collide it results in a stalemate and the drones
             * will be tied together inline.
            */
